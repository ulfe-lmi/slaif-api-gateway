...
LOCAL_CODING_SSE_OBLIGATION_TO_TEST_NODE = {
    ...
    "progress.source-fixture": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_emission_fixture_is_pinned_and_exact",
    "progress.created-positive": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_source_shaped_progress_event_accepts_full_default_null_envelope[created]",
    "progress.in-progress-positive": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_source_shaped_progress_event_accepts_full_default_null_envelope[in-progress]",
    "progress.created-output-nonempty": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[created-output-nonempty-list]",
    "progress.created-output-mapping": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[created-output-mapping]",
    "progress.created-output-string": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[created-output-string]",
    "progress.created-output-null": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[created-output-null]",
    "progress.created-usage-mapping": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[created-usage-non-null-mapping]",
    "progress.created-usage-string": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[created-usage-malformed-string]",
    "progress.created-output-large": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[created-output-generated-large]",
    "progress.in-progress-output-nonempty": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[in-progress-output-nonempty-list]",
    "progress.in-progress-output-mapping": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[in-progress-output-mapping]",
    "progress.in-progress-output-string": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[in-progress-output-string]",
    "progress.in-progress-output-null": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[in-progress-output-null]",
    "progress.in-progress-usage-mapping": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[in-progress-usage-non-null-mapping]",
    "progress.in-progress-usage-string": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[in-progress-usage-malformed-string]",
    "progress.in-progress-output-large": "tests/unit/test_responses_codex_streaming_tools.py::test_vllm_progress_output_and_usage_shapes_fail_closed_without_echo[in-progress-output-generated-large]",
}
...
LOCAL_CODING_SSE_REQUIRED_OBLIGATION_IDS = frozenset(
    {
        ...
        "progress.source-fixture",
        "progress.created-positive",
        "progress.in-progress-positive",
        "progress.created-output-nonempty",
        "progress.created-output-mapping",
        "progress.created-output-string",
        "progress.created-output-null",
        "progress.created-usage-mapping",
        "progress.created-usage-string",
        "progress.created-output-large",
        "progress.in-progress-output-nonempty",
        "progress.in-progress-output-mapping",
        "progress.in-progress-output-string",
        "progress.in-progress-output-null",
        "progress.in-progress-usage-mapping",
        "progress.in-progress-usage-string",
        "progress.in-progress-output-large",
    }
)
