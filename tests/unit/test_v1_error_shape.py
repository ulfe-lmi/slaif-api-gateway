...
def test_unimplemented_responses_rc2_routes_keep_openai_error_shape() -> None:
    for method, path, expected_status, expected_type in (
        ...
        ("post", "/v1/realtime/client_secrets", 401, "authentication_error"),
        ("post", "/v1/realtime", 404, "invalid_request_error"),
        ("post", "/v1/realtime/calls", 404, "invalid_request_error"),
        ("post", "/v1/realtime/transcription_sessions", 404, "invalid_request_error"),
