...
@pytest.mark.asyncio
async def test_openrouter_response_posts_previous_response_id_body(respx_mock) -> None:
    route = respx_mock.post("https://openrouter.ai/api/v1/responses").mock(
        return_value=httpx.Response(
            200,
            json={
            ...
            headers={"X-OpenRouter-Request-ID": "req-openrouter-response-previous"},
        )
    )
    adapter = OpenRouterProviderAdapter(Settings(OPENROUTER_API_KEY="openrouter-upstream-key"))
    caller_body = {
    ...
    assert response.upstream_request_id == "req-openrouter-response-previous"
...
@pytest.mark.asyncio
async def test_openrouter_response_posts_image_input_request(respx_mock) -> None:
    route = respx_mock.post("https://openrouter.ai/api/v1/responses").mock(
        return_value=httpx.Response(
            200,
            json={
            ...
            headers={"X-OpenRouter-Request-ID": "req-openrouter-response-image"},
        )
    )
    adapter = OpenRouterProviderAdapter(Settings(OPENROUTER_API_KEY="openrouter-upstream-key"))
    caller_body = {
...
@pytest.mark.asyncio
async def test_openrouter_response_posts_file_input_request(respx_mock) -> None:
    route = respx_mock.post("https://openrouter.ai/api/v1/responses").mock(
        return_value=httpx.Response(
            200,
            json={
            ...
            headers={"X-OpenRouter-Request-ID": "req-openrouter-response-file"},
        )
    )
    adapter = OpenRouterProviderAdapter(Settings(OPENROUTER_API_KEY="openrouter-upstream-key"))
    caller_body = {
