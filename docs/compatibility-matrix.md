...
| Dashboard management pages | Partial | None | Read-only key list/detail pages exist; key mutation, owner, institution, cohort, pricing, routing, provider, usage, and email delivery web management pages remain out of scope for current implementation | Admin key page tests |
