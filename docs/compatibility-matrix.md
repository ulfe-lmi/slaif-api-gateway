...
| Dashboard management pages | Partial | None | Read-only key, owner, institution, cohort, provider, route, pricing, and FX pages exist; mutation, usage, audit, and email delivery web management pages remain out of scope for current implementation | Admin dashboard page tests |
