...
- Manual stale quota-reservation reconciliation for operator repair of expired pending reservations after crashes, plus an opt-in Celery/Celery Beat foundation for scheduled backlog inspection and explicitly enabled dry-run/execute reconciliation.
