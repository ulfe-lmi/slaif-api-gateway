...
- Bulk key creation forms, arbitrary/old-key dashboard email resend actions, FX import/upload/external-refresh forms, and state-changing management pages for owners, institutions, cohorts, usage, and audit.
...
Arbitrary old-key dashboard email resend actions, bulk key creation forms, FX import/upload/external-refresh forms, and owner, institution, cohort, usage, and audit mutation pages are not implemented yet.
...
Near-term remaining work includes owner/institution/cohort mutation pages, bulk key creation, FX import workflows, OpenTelemetry tracing, and fuller production hardening runbooks.
