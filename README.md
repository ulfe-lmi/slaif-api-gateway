...
- Responses hosted/provider-side tools, MCP/connectors, web/file search, code
  ...
  lifecycle, conversation item/update endpoints, response cancel/list endpoints,
