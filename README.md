...
- Responses hosted/provider-side tools, MCP/connectors, web/file search, code
  ...
  lifecycle, provider-side Responses storage/state, `previous_response_id`,
  conversations, response retrieval/cancel/delete/list/input-item endpoints,
  and multimodal output. The implemented Responses subset remains stateless,
  text-output only, and local/client-side for tools.
