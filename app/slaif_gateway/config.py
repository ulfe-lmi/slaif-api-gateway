...
class Settings(BaseSettings):
    ...
    RECONCILIATION_EXTERNAL_TOOL_HOLD_LIMIT: int = 100
    ...
    RECONCILIATION_ALERT_MIN_EXTERNAL_TOOL_HOLDS: int = 1
    ...
    CODEX_ABSOLUTE_MAX_INPUT_TOKENS: int = 1050000
    CODEX_ABSOLUTE_MAX_OUTPUT_TOKENS: int = 128000
    ...
    def _validate_reconciliation_settings(self) -> None:
        ...
        if self.RECONCILIATION_EXTERNAL_TOOL_HOLD_LIMIT <= 0:
            raise ValueError("RECONCILIATION_EXTERNAL_TOOL_HOLD_LIMIT must be a positive integer")
        ...
        if self.RECONCILIATION_ALERT_MIN_EXTERNAL_TOOL_HOLDS < 0:
            raise ValueError(
                "RECONCILIATION_ALERT_MIN_EXTERNAL_TOOL_HOLDS must be greater than or equal to 0"
            )
    ...
    def _validate_request_caps(self) -> None:
        for name in (
            ...
            "CODEX_ABSOLUTE_MAX_INPUT_TOKENS",
            "CODEX_ABSOLUTE_MAX_OUTPUT_TOKENS",
