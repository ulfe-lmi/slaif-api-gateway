...
def _to_route_list_row(
    ...
    *,
    ...
    return AdminRouteListRow(
        ...
        codex_profile_id=qualification.profile_id,
        codex_metadata_version=qualification.metadata_version,
        codex_cli_version=qualification.cli_version,
        codex_profile_name=qualification.profile,
